...
import static net.vulkanmod.render.chunk.build.pipeline.mesh.EncodingFormat.HEADER_BITS;
import static net.vulkanmod.render.chunk.build.pipeline.mesh.EncodingFormat.HEADER_COLOR_INDEX;
import static net.vulkanmod.render.chunk.build.pipeline.mesh.EncodingFormat.HEADER_FACE_NORMAL;
import static net.vulkanmod.render.chunk.build.pipeline.mesh.EncodingFormat.HEADER_STRIDE;
import static net.vulkanmod.render.chunk.build.pipeline.mesh.EncodingFormat.HEADER_TAG;
import static net.vulkanmod.render.chunk.build.pipeline.mesh.EncodingFormat.QUAD_STRIDE;
import static net.vulkanmod.render.chunk.build.pipeline.mesh.EncodingFormat.VERTEX_COLOR;
import static net.vulkanmod.render.chunk.build.pipeline.mesh.EncodingFormat.VERTEX_LIGHTMAP;
import static net.vulkanmod.render.chunk.build.pipeline.mesh.EncodingFormat.VERTEX_NORMAL;
import static net.vulkanmod.render.chunk.build.pipeline.mesh.EncodingFormat.VERTEX_STRIDE;
import static net.vulkanmod.render.chunk.build.pipeline.mesh.EncodingFormat.VERTEX_U;
import static net.vulkanmod.render.chunk.build.pipeline.mesh.EncodingFormat.VERTEX_V;
import static net.vulkanmod.render.chunk.build.pipeline.mesh.EncodingFormat.VERTEX_X;
